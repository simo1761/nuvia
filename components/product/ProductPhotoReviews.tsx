...
const photoReviews = [
  ...
  },
  {
    ...
    city: 'الكويت',
    rating: 5,
    text: 'الكيت وصل بشكل أنيق وبدأت نفس اليوم. بعد 3 أسابيع لاحظت فرقاً ملحوظاً في منطقة الأرداف. الجهاز سهل الاستخدام ورائحة الزيت منعشة جداً!',
    date: '2 ديسمبر 2024',
  },
  {
  ...
  },
  {
    ...
    city: 'الرياض',
    rating: 5,
    text: 'بعد 4 أسابيع من الاستخدام المنتظم، السيلوليت تقلص بشكل واضح جداً. الزيت رائحته رائعة والجهاز يعمل بكفاءة عالية. 100٪ أنصح به.',
    date: '10 يناير 2025',
  },
  {
    ...
    city: 'الكويت',
    rating: 5,
    text: 'زيت الزنجبيل رهيب! الدفء اللي يحس فيه على الجلد يدل إنه يشتغل. استخدمته 3 أسابيع وشفت فرق واضح جداً في الأفخاذ.',
    date: '17 يناير 2025',
  },
  {
  ...
  },
  {
    ...
    city: 'دبي',
    rating: 5,
    text: 'أفضل هدية قدمتها لنفسي في 2025! الجهاز يعمل بشكل مذهل والزيت رائحته فاخرة جداً. النتائج تكلم نفسها بعد أسبوعين.',
    date: '21 فبراير 2025',
  },
  {
