...
// Tracking pixels and footer don't block first paint
    ...
    <html lang="ar" dir="rtl" className={tajawal.variable}>
      <body className="font-tajawal bg-bg text-nuvia-text antialiased">
        ...
        <a
          ...
          className="fixed bottom-6 left-6 z-50 w-14 h-14 bg-green-500 hover:bg-green-600 text-white rounded-full shadow-lg flex items-center justify-center transition-all duration-300 hover:scale-110"
