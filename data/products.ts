...
export const products: Product[] = [
  ...
  // ── Produit 5 — Pack RF + Crème ───────────────────────────────────
  {
    id: '5',
    slug: 'pack-rf',
    sku: 'NV-RF-005',
    name: 'باقة RF لشد الجلد',
    nameEn: 'Nuvia RF Skin Tightening Kit',
    tagline: 'جهاز الترددات الراديوية RF + كريم الشد — تقنية طبية لبشرة أكثر شباباً',
    description:
      'باقة نوفيا RF الاحترافية: جهاز الترددات الراديوية بشاشة LED ذكية وحلقة ذهبية فاخرة، مدعوم بكريم الشد المتخصص. يعمل على تحفيز إنتاج الكولاجين وشد الجلد المترهل، مع تقليل مظهر السيلوليت بفاعلية عالية خلال 4 أسابيع.',
    ...
    benefits: [
      ...
      'شد الجلد المترهل وتقليل التجاعيد',
      'شاشة LED ذكية لضبط درجة الحرارة',
      'كريم شد متخصص معزز بالببتيدات',
      'نتائج مرئية خلال 4 أسابيع',
      'مناسب للجسم والوجه والأفخاذ',
    ],
    howToUse: [
      'ضعي كمية من الكريم على المنطقة المستهدفة',
      'شغّلي جهاز RF على الوضع المناسب لبشرتك',
      'حرّكي الجهاز بحركات دائرية بطيئة',
      'استخدميه 3 مرات أسبوعياً لمدة 20 دقيقة',
    ],
    ingredients: [
      'ببتيدات الكولاجين',
      'حمض الهيالورونيك',
  ...
  // ── Produit 6 — Pack Ultrasons + Gel ──────────────────────────────
  {
    id: '6',
    slug: 'pack-ultrasons',
    sku: 'NV-US-006',
    name: 'باقة الموجات الفوقية الصوتية',
    nameEn: 'Nuvia Ultrasonic 3-in-1 Kit',
    tagline: 'جهاز EMS + أشعة تحت الحمراء + موجات صوتية + جل التوصيل — ثلاثة في واحد',
    description:
      'الباقة الأكثر تطوراً من نوفيا: جهاز 3-في-1 يجمع بين الموجات فوق الصوتية والإشعاع تحت الحمراء وتحفيز EMS، مع جل التوصيل الاحترافي. يستهدف السيلوليت العميق ويحلل الدهون المتراكمة ويرسّخ نتائج دائمة.',
    price: 269, // TODO: update price before launch
    currency: 'SAR',
    images: [
      '/images/products/pack-ultrasons-placeholder.svg',
      '/images/products/pack-ultrasons-placeholder.svg',
    ],
    benefits: [
      'تقنية 3-في-1: موجات صوتية + IR + EMS',
      'يستهدف السيلوليت العميق تحت الجلد',
      'تحليل الدهون المتراكمة العنيدة',
      'جل توصيل احترافي يعزز الفاعلية',
      'حلقة LED حمراء للإشعاع تحت الحمراء',
      'نتائج مرئية خلال أسبوعين',
    ],
    howToUse: [
      'ضعي كمية سخية من جل التوصيل على المنطقة',
      'اختاري الوضع المناسب على الجهاز (صوتي / IR / EMS)',
      'حرّكي الجهاز ببطء بحركات دوائر',
      'استخدميه يومياً لمدة 15-20 دقيقة',
    ],
    ingredients: [
      'جل التوصيل الإيوني',
